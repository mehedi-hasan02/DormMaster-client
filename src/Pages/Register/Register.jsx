  ...
  return (
    <div className="hero min-h-screen bg-base-200">
      ...
      <div
        ...
        className="hero-content flex-col lg:flex-row-reverse shadow-2xl p-20"
      >
            ...
            <div className="form-control">
              ...
              <div className="flex items-center w-full relative">
                ...
                <span onClick={() => setShowPassword(!showPassword)}>
                  {showPassword ? (
                    <FaEyeSlash className="absolute top-4 right-2 cursor-pointer"></FaEyeSlash>
                  ) : (
                    <FaEye className="absolute top-4 right-2 cursor-pointer" />
                  )}
                </span>
              </div>
