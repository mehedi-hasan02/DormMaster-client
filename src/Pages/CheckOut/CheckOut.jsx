...
const CheckOut = () => {
    ...
    return (
        <div className="flex justify-center lg:min-h-[660px]">
            <div className="w-full px-4 py-3 bg-white rounded-md shadow-md dark:bg-gray-800 w-[400px] h-72 mt-16">
                <div className="flex items-center justify-between mb-5">
                    ...
                    <button className="px-3 py-1 text-xs text-blue-800 uppercase bg-blue-200 rounded-full dark:bg-blue-300 dark:text-blue-900">Pay</button>
